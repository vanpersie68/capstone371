  ...
  <div class="options">
    ...
    <div v-if="question.articleStyle === 'Linkedin'">
      ...
      <div class="text-with-button">
        ...
        <toggle-base
          :toggled="question.articleSendsOn"
          @handleToggle="activateSendCount"
        ></toggle-base>
      </div>
    </div>
    ...
    <text-box-num
      :value="question.addon.length.toString()"
      @update="
        (value) =>
      ...
      "
      :key="this.question.addon.length"
    ...
    <text-box-num
      :value="question.comments ? question.comments.length.toString() : '0'"
      @update="
        (value) =>
          $store.commit('updateAddonList', {
            question: question,
      ...
      "
      :key="question.comments ? question.comments.length.toString() : '0'"
      @increment="insertComment($store)"
