<template>
  <div class="question-box" :style="color">
    ...
    <PostTwitterReadOnly
      v-if="questionData.articleStyle === 'Twitter'"
      @updateAnswer="getData"
      :question="questionData"
    ></PostTwitterReadOnly>
    <PostFacebookReadOnly
      v-else-if="questionData.articleStyle === 'Facebook'"
      @updateAnswer="getData"
      :question="questionData"
    ></PostFacebookReadOnly>
    <PostInstagramReadOnly
      v-else-if="questionData.articleStyle === 'Instagram'"
      @updateAnswer="getData"
      :question="questionData"
    ></PostInstagramReadOnly>
    <YouTubeReadOnly
      ref="youtubeid"
      v-else-if="questionData.articleStyle === 'Youtube'"
      @updateAnswer="getData"
      :question="questionData"
    ></YouTubeReadOnly>
    <TikTokReadOnly
      ref="tiktokid"
      v-else-if="questionData.articleStyle === 'TikTok'"
      @updateAnswer="getData"
      :question="questionData"
    ></TikTokReadOnly>
    <PostRedditReadOnly
      v-else-if="questionData.articleStyle === 'Reddit'"
      @updateAnswer="getData"
      :question="questionData"
    ></PostRedditReadOnly>
    <PostLinkedinReadOnly
      v-else-if="questionData.articleStyle === 'Linkedin'"
      @updateAnswer="getData"
      :question="questionData"
    ></PostLinkedinReadOnly>
    <PostTumblrReadOnly
      v-else-if="questionData.articleStyle === 'Tumblr'"
      @updateAnswer="getData"
      :question="questionData"
    ></PostTumblrReadOnly>
    <PostPinterestReadOnly
      v-else-if="questionData.articleStyle === 'Pinterest'"
      @updateAnswer="getData"
      :question="questionData"
    ></PostPinterestReadOnly>
