            ...
            <div class="row">
              <div class="column">
                ...
                <input
                  type="text"
                  id="fname"
                  :placeholder="$t('g5.enterFirstName')"
                  v-model="first_name"
                />
                ...
                <input
                  type="text"
                  id="lname"
                  :placeholder="$t('g5.enterLastName')"
                  v-model="last_name"
                />
              </div>
              <div class="column">
                ...
                <div>
                  <input
                    type="password"
                    id="cpassword"
                    :placeholder="$t('g5.enterCurrentPassword')"
                ...
                <div>
                  <input
                    type="password"
                    id="npassword"
                    :placeholder="$t('g5.enterNewPassword')"
                ...
                <div>
                  <input
                    type="password"
                    id="confirmnpassword"
                    :placeholder="$t('g5.confirmPassword')"
